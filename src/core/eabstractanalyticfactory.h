 ...
 * available analytic types the program that uses the ACE library provides.
 * Unlike the data factory the integers defining analytic types does not need to
 * be constant for backwards compatibility.
 */
...
public:
   /*!
    * This interface returns the total number of analytic types a program
    * implements for ACE. All integers from 0 to one less than the size returned
    * must be defined as a unique analytic type.
    *
   ...
   /*!
    * This interface returns the command line name for the given analytic type.
    * This name must be unique among all other analytic command line names.
    *
    * @param type The analytic type whose display name is returned.
    *
