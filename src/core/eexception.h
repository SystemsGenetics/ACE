 ...
 * programs that use the ACE framework. This contains all information about
 * where the exception was thrown along with a description about what the error.
 * A macro is provided for creating exceptions that fills in the file name,
