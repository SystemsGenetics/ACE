 ...
 *
 * @param other The other event object whose OpenCL event or null state is
 *              taken.
 */
 ...
 *
 * @param id The OpenCL event ID that this new event contains. This must be a
 *           valid OpenCL event that has one reference count.
 */
...
/*!
 * Constructs a new event taking the OpenCL event or null state of the given
 * event.
 *
