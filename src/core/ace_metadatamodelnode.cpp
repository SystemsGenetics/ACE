 ...
 */
MetadataModelNode::MetadataModelNode(EMetadata::Type type, QObject* parent)
   :
   QObject(parent),
   _meta(type)
{
 ...
 * @param parent The parent of this new node, if any.
 */
MetadataModelNode::MetadataModelNode(const EMetadata& meta, QObject* parent)
   :
   QObject(parent)
{
   ...
   // If the metadata is an array or object then make a copy of it without copying
   // its children.
   ...
   // Else copy the given metadata into this node.
   else
   {
      _meta = meta;
   }
 ...
 */
MetadataModelNode::MetadataModelNode(const MetadataModelNode& object)
   :
   QObject(),
   _meta(object._meta)
{
   ...
   {
      MetadataModelNode* child {new MetadataModelNode(*pointer)};
      child->setParent(this);
      _array << new MetadataModelNode(*pointer);
   }
   for (auto i = object._map.cbegin(); i != object._map.cend() ;++i)
   {
      MetadataModelNode* child {new MetadataModelNode(**i)};
      child->setParent(this);
 ...
 */
bool MetadataModelNode::isBytes() const
{
   EDEBUG_FUNC(this);
 ...
 */
bool MetadataModelNode::isEditable() const
{
   EDEBUG_FUNC(this);
 ...
 */
bool MetadataModelNode::isContainer() const
{
   EDEBUG_FUNC(this);
 ...
 */
bool MetadataModelNode::isArray() const
{
   EDEBUG_FUNC(this);
 ...
 */
bool MetadataModelNode::isObject() const
{
   EDEBUG_FUNC(this);
 ...
 */
int MetadataModelNode::size() const
{
   // Add the debug header.
   EDEBUG_FUNC(this);
 ...
 */
MetadataModelNode* MetadataModelNode::parent() const
{
   EDEBUG_FUNC(this);
   return qobject_cast<MetadataModelNode*>(QObject::parent());
}
 ...
 */
QString MetadataModelNode::key() const
{
   // Add the debug header.
   EDEBUG_FUNC(this);

   // Get a pointer to this node's parent, casting it is a node pointer itself.
   const MetadataModelNode* parent_ {qobject_cast<const MetadataModelNode*>(parent())};
 ...
 */
bool MetadataModelNode::setKey(const QString& newKey)
{
   // Add the debug header.
   EDEBUG_FUNC(this,newKey);

   // Get pointer to this node's parent.
   MetadataModelNode* parent_ {parent()};
   ...
   // the new key.
   QMap<QString,MetadataModelNode*>& map_ {parent_->_map};
 ...
 */
QString MetadataModelNode::type() const
{
   EDEBUG_FUNC(this);
 ...
 */
QByteArray MetadataModelNode::bytes() const
{
   // Add the debug header.
   EDEBUG_FUNC(this);
 ...
 */
EMetadata MetadataModelNode::meta() const
{
   EDEBUG_FUNC(this);
   return _meta;
}
 ...
 */
QVariant MetadataModelNode::value() const
{
   // Add the debug header.
   EDEBUG_FUNC(this);
 ...
 *         value was set.
 */
bool MetadataModelNode::setValue(const QVariant& value)
{
   // Add the debug header.
 ...
 */
QList<MetadataModelNode*>::const_iterator MetadataModelNode::arrayBegin() const
{
   EDEBUG_FUNC(this);
   return _array.begin();
}
 ...
 */
QList<MetadataModelNode*>::const_iterator MetadataModelNode::arrayEnd() const
{
   EDEBUG_FUNC(this);
   return _array.end();
}
 ...
 */
QMap<QString,MetadataModelNode*>::const_iterator MetadataModelNode::objectBegin() const
{
   EDEBUG_FUNC(this);
   return _map.begin();
}
 ...
 */
QMap<QString,MetadataModelNode*>::const_iterator MetadataModelNode::objectEnd() const
{
   EDEBUG_FUNC(this);
   return _map.end();
}
 ...
 */
MetadataModelNode* MetadataModelNode::get(int index) const
{
   // Add the debug header.
   EDEBUG_FUNC(this,index);

   // Initialize return pointer variable to null.
   MetadataModelNode* ret {nullptr};
 ...
 *         found.
 */
int MetadataModelNode::indexOf(const MetadataModelNode* pointer) const
{
   // Add the debug header.
 ...
 */
bool MetadataModelNode::contains(const QString& key) const
{
 ...
 */
int MetadataModelNode::getFutureIndex(const QString& key) const
{
   // Add the debug header.
   EDEBUG_FUNC(this,key);

   // Get the distance, make sure it is within limits of an integer, and then return
   // it as such.
   auto ret {std::distance(_map.begin(),_map.lowerBound(key))};
   Q_ASSERT(ret < std::numeric_limits<int>::max());
 ...
 *         exists.
 */
std::unique_ptr<MetadataModelNode> MetadataModelNode::copy(int index)
{
   // Add the debug header.
   EDEBUG_FUNC(this,index);

   // Initialize the return smart pointer to null.
   std::unique_ptr<MetadataModelNode> ret;
   ...
   if ( index > 0 )
   {
      if ( isArray() && index < _array.size() )
      {
         ret.reset(new MetadataModelNode(*_array.at(index)));
      }
      else if ( isObject() && index < _map.size() )
      {
         ret.reset(new MetadataModelNode(*_map.values().at(index)));
      }
   }
 ...
 *         exists.
 */
std::unique_ptr<MetadataModelNode> MetadataModelNode::cut(int index)
{
   // Add the debug header.
   EDEBUG_FUNC(this,index);
 ...
 */
void MetadataModelNode::insertArray(int index, std::unique_ptr<MetadataModelNode>&& node)
{
   // Add the debug header.
 ...
 */
void MetadataModelNode::insertObject(const QString& key, std::unique_ptr<MetadataModelNode>&& node)
{
   // Add the debug header.
 ...
 */
void MetadataModelNode::remove(int index)
{
   // Add the debug header.
   EDEBUG_FUNC(this,index);
