...
namespace OpenCL
{
    ...
    * methods for iterating through all OpenCL devices of their respective
    * platform. This class is not intended to be instantiated on its own but
    * instead queried through the static methods. Any pointer to a platform the
    * static methods return will exist for the lifetime of the ACE program.
    */
