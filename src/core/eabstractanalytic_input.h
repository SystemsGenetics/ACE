#ifndef EABSTRACTANALYTIC_INPUT_H
#define EABSTRACTANALYTIC_INPUT_H
 ...
 * parent analytic. An implementation of this class must define all inputs for its 
 * analytic type and then handle setting all values for that input to its parent 
 * analytic. For file and data object inputs/outputs the ACE system handles closing 
 * them on its own so an implementation of this class does not need to worry about 
 * that; for those types only a pointer is passed and not actual ownership of the 
 * underlying objects. 
 */
class EAbstractAnalytic::Input : public QObject
{
   Q_OBJECT
public:
   /*!
   ...
   enum Type
   {
      ...
      ,String
      /*!
       * Defines the selection argument type. A selection is a list of predefined strings 
   ...
   {
      /*!
       * Defines the command line name for an argument. This data is a string and unique 
       * within all other arguments for an analytic type. 
       */
      CommandLineName
      /*!
      ...
      ,Title
      /*!
       * Defines the "What's this?" for an argument. This data is a string that is used 
       * to describe what this argument is to the end user. 
       */
      ,WhatsThis
      /*!
       * Defines the default value for an argument. This data is a variant type depending 
       * on the argument type. 
       */
      ,Default
      /*!
       * Defines the minimum value for a number argument. This data is an integer or real 
       * number. 
       */
      ,Minimum
      /*!
       * Defines the maximum value for a number argument. This data is an integer or real 
       * number. 
       */
      ,Maximum
      /*!
       * Defines the decimal precision used for a real number argument. This data is an 
       * integer. 
       */
      ,Decimals
      /*!
      ...
      ,SelectionValues
      /*!
       * Defines the file filters used for a file input/output argument. This data is a 
       * string that defines file filters as defined by Qt. 
       */
      ,FileFilters
      /*!
       * Defines the data type for a data input/output argument. This data is an integer 
       * that identifies a unique data type. 
       */
      ,DataType
   };
   /*!
