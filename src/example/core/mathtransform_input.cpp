...
{
   // Based off the argument index given call the appropriate method with the given 
...
{
   // Based off the argument index given set this object's parent analytic object's 
