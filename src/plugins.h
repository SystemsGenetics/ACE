...
#define ACE_BEGIN_DATA ::AccelCompEng::DataPlugin* ::AccelCompEng::new_data(\
...
#define ACE_BEGIN_ANALYTIC ::AccelCompEng::AnalyticPlugin*\
                                                  ::AccelCompEng::new_analytic(\
                                                       const std::string& type)\
                           {\
                              ::AccelCompEng::AnalyticPlugin* ret = nullptr;
#define ACE_ANALYTIC_PLUGIN(N,A) if (type==std::string(#N)) ret =\
                                                               new A();
